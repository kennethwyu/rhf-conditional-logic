var rhfConditionalLogic = function(exports, reactHookForm) {
  "use strict";
  ...
  function useCondition(fieldNamePaths, conditions, getValues, control) {
    ...
    reactHookForm.useWatch({ control, name: Array.from(dependencies) });
  ...
  exports.getConditionalLogic = getConditionalLogic;
  exports.getConditionalLogicWithDependencies = getConditionalLogicWithDependencies;
  exports.pruneHiddenFields = pruneHiddenFields;
  exports.useCondition = useCondition;
  exports.useConditionalForm = useConditionalForm;
